...
// Define arrays of traits with their sources
    const maneColorSources = {
        "BO_Main_Color": ["Algae", "Amber", "Anjeer", "Ashen", "Briar", "Cameo", "Champagne", "Chartreux", "Cimmerian", "Cinnabar", "Cocoa", "Dinar", "Ebony", "Fiery", "Flaxen", "Flint", "Fulvous", "Goldenrod", "Honey", "Lilac", "Nacarat", "Orchid", "Pearl", "Pistachio", "Platinum", "Prune", "Ruffian", "Scoundrel", "Sepia", "Shedua", "Slate", "Taupe", "Ukame", "Umber"],
        "Exclusive_NCL_Mane_Color": ["Clay", "Copal", "Marigold"],
		"Combo_Mane": ["Cairngorm", "Citrine", "Elysian", "Madagascar", "Qahir", "Serruria", "Soul"]
